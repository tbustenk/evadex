...
REGIONAL_TIER: frozenset[PayloadCategory] = CORE_TIER | frozenset(
    {
        ...
        PayloadCategory.AT_DL,
        PayloadCategory.AT_ID_CARD,
        PayloadCategory.AT_PASSPORT,
        PayloadCategory.AT_TAX_NUM,
        PayloadCategory.BE_NRN,
        PayloadCategory.BE_DL,
        PayloadCategory.BE_PASSPORT,
        PayloadCategory.BE_VAT,
        PayloadCategory.BG_EGN,
        PayloadCategory.BG_ID_CARD,
        PayloadCategory.BG_LNC,
        PayloadCategory.BG_PASSPORT,
        PayloadCategory.HR_OIB,
        PayloadCategory.HR_DL,
        PayloadCategory.HR_ID_CARD,
        PayloadCategory.HR_PASSPORT,
        PayloadCategory.CY_TIN,
        PayloadCategory.CY_ID_CARD,
        PayloadCategory.CY_PASSPORT,
        PayloadCategory.CZ_RC,
        PayloadCategory.CZ_DL,
        PayloadCategory.CZ_ICO,
        PayloadCategory.CZ_PASSPORT,
        PayloadCategory.DK_CPR,
        PayloadCategory.DK_DL,
        PayloadCategory.DK_PASSPORT,
        PayloadCategory.EE_IK,
        PayloadCategory.EE_DL,
        PayloadCategory.EE_PASSPORT,
        PayloadCategory.EU_VAT,
        PayloadCategory.EU_ETD,
        PayloadCategory.FI_DL,
        PayloadCategory.FI_PASSPORT,
        PayloadCategory.FR_DL,
        PayloadCategory.FR_PASSPORT,
        PayloadCategory.GR_AMKA,
        PayloadCategory.GR_AFM,
        PayloadCategory.GR_DL,
        PayloadCategory.GR_ID_CARD,
        PayloadCategory.GR_PASSPORT,
        PayloadCategory.HU_TAJ,
        PayloadCategory.HU_DL,
        PayloadCategory.HU_PASSPORT,
        PayloadCategory.HU_PERSONAL_ID,
        PayloadCategory.HU_TAX_NUM,
        PayloadCategory.IS_KT,
        PayloadCategory.IS_PASSPORT,
        PayloadCategory.IE_PPS,
        PayloadCategory.IE_DL,
        PayloadCategory.IE_EIRCODE,
        PayloadCategory.IE_PASSPORT,
        PayloadCategory.IT_DL,
        PayloadCategory.IT_PIVA,
        PayloadCategory.IT_PASSPORT,
        PayloadCategory.IT_SSN,
        PayloadCategory.LV_PK,
        PayloadCategory.LV_DL,
        PayloadCategory.LV_PASSPORT,
        PayloadCategory.LI_PP,
        PayloadCategory.LI_PIN,
        PayloadCategory.LT_AK,
        PayloadCategory.LT_DL,
        PayloadCategory.LT_PASSPORT,
        PayloadCategory.LU_NIN,
        PayloadCategory.LU_DL,
        PayloadCategory.LU_PASSPORT,
        PayloadCategory.MT_ID,
        PayloadCategory.MT_PASSPORT,
        PayloadCategory.MT_TIN,
        PayloadCategory.NL_PASSPORT,
        PayloadCategory.NO_D_NUMBER,
        PayloadCategory.NO_DL,
        PayloadCategory.NO_PASSPORT,
        PayloadCategory.PL_DL,
        PayloadCategory.PL_ID_CARD,
        PayloadCategory.PL_NIP,
        PayloadCategory.PL_PASSPORT,
        PayloadCategory.PL_REGON,
        PayloadCategory.PT_NIF,
        PayloadCategory.PT_CC,
        PayloadCategory.PT_NISS,
        PayloadCategory.PT_PASSPORT,
        PayloadCategory.RO_CNP,
        PayloadCategory.RO_CIF,
        PayloadCategory.RO_DL,
        PayloadCategory.RO_PASSPORT,
        PayloadCategory.SK_BN,
        PayloadCategory.SK_DL,
        PayloadCategory.SK_PASSPORT,
        PayloadCategory.SI_EMSO,
        PayloadCategory.SI_DL,
        PayloadCategory.SI_PASSPORT,
        PayloadCategory.SI_TAX_NUM,
        PayloadCategory.SE_DL,
        PayloadCategory.SE_ORG_NUM,
        PayloadCategory.SE_PASSPORT,
        PayloadCategory.CH_DL,
        PayloadCategory.CH_PASSPORT,
        PayloadCategory.CH_UID,
        PayloadCategory.TR_TC,
        PayloadCategory.TR_DL,
        PayloadCategory.TR_PASSPORT,
        PayloadCategory.TR_TAX_ID,
        # Asia-Pacific — full
        PayloadCategory.HK_HKID,
        PayloadCategory.BD_NID,
        PayloadCategory.BD_PASSPORT,
        PayloadCategory.BD_TIN,
        PayloadCategory.CN_RID,
        PayloadCategory.CN_PASSPORT,
        PayloadCategory.MO_ID,
        PayloadCategory.TW_NID,
        PayloadCategory.ID_NIK,
        PayloadCategory.ID_NPWP,
        PayloadCategory.ID_PASSPORT,
        PayloadCategory.IN_DL,
        PayloadCategory.IN_PASSPORT,
        PayloadCategory.IN_RATION_CARD,
        PayloadCategory.IN_VOTER_ID,
        PayloadCategory.JP_DL,
        PayloadCategory.JP_HEALTH_INS,
        PayloadCategory.JP_JUMINHYO,
        PayloadCategory.JP_PASSPORT,
        PayloadCategory.JP_RESIDENCE_CARD,
        PayloadCategory.KR_RRN,
        PayloadCategory.KR_DL,
        PayloadCategory.KR_PASSPORT,
        PayloadCategory.LK_NIC,
        PayloadCategory.LK_NIC_NEW,
        PayloadCategory.LK_PASSPORT,
        ...
        PayloadCategory.PH_PASSPORT,
        PayloadCategory.PH_PHILHEALTH,
        PayloadCategory.PH_SSS,
        PayloadCategory.PH_TIN,
        PayloadCategory.PH_UMID,
        PayloadCategory.SG_DL,
        PayloadCategory.SG_FIN,
        PayloadCategory.SG_PASSPORT,
        PayloadCategory.TH_NID,
        PayloadCategory.TH_DL,
        PayloadCategory.TH_PASSPORT,
        PayloadCategory.TH_TAX_ID,
        PayloadCategory.VN_CCCD,
        PayloadCategory.VN_PASSPORT,
        PayloadCategory.VN_TAX_CODE,
        # Latin America — full
        PayloadCategory.AR_DNI,
        PayloadCategory.AR_CUIL_CUIT,
        PayloadCategory.AR_PASSPORT,
        PayloadCategory.BR_CNPJ,
        PayloadCategory.BR_CNH,
        PayloadCategory.BR_PASSPORT,
        PayloadCategory.BR_RG,
        PayloadCategory.BR_SUS,
        PayloadCategory.CL_RUT,
        PayloadCategory.CL_PASSPORT,
        PayloadCategory.CO_CEDULA,
        PayloadCategory.CO_NIT,
        PayloadCategory.CO_NUIP,
        PayloadCategory.CO_PASSPORT,
        PayloadCategory.CR_CEDULA,
        PayloadCategory.CR_DIMEX,
        PayloadCategory.CR_PASSPORT,
        PayloadCategory.EC_CEDULA,
        PayloadCategory.EC_PASSPORT,
        PayloadCategory.EC_RUC,
        PayloadCategory.MX_CURP,
        PayloadCategory.MX_CLAVE_ELECTOR,
        PayloadCategory.MX_INE_CIC,
        PayloadCategory.MX_INE_OCR,
        PayloadCategory.MX_NSS,
        PayloadCategory.MX_PASSPORT,
        PayloadCategory.MX_RFC,
        PayloadCategory.PY_RUC,
        PayloadCategory.PY_CEDULA,
        PayloadCategory.PY_PASSPORT,
        ...
        PayloadCategory.UY_PASSPORT,
        PayloadCategory.UY_RUT,
        PayloadCategory.VE_CEDULA,
        PayloadCategory.VE_PASSPORT,
        PayloadCategory.VE_RIF,
        # Middle East
        PayloadCategory.UAE_EID,
        PayloadCategory.UAE_PASSPORT,
        PayloadCategory.UAE_VISA,
        PayloadCategory.SA_NID,
        PayloadCategory.SA_PASSPORT,
        PayloadCategory.ZA_ID,
        PayloadCategory.ZA_DL,
        PayloadCategory.ZA_PASSPORT,
        PayloadCategory.IL_ID,
        PayloadCategory.IL_PASSPORT,
        PayloadCategory.BH_CPR,
        PayloadCategory.BH_PASSPORT,
        PayloadCategory.IR_MELLI,
        PayloadCategory.IR_PASSPORT,
        PayloadCategory.IQ_NID,
        PayloadCategory.IQ_PASSPORT,
        PayloadCategory.JO_NID,
        PayloadCategory.JO_PASSPORT,
        PayloadCategory.KW_CIVIL,
        PayloadCategory.KW_PASSPORT,
        PayloadCategory.LB_PP,
        PayloadCategory.LB_ID,
        PayloadCategory.QA_QID,
        PayloadCategory.QA_PASSPORT,
    }
)
...
def get_tier_categories(tier: str) -> frozenset[PayloadCategory] | None:
    ...
    if tier == "full":
        return FULL_TIER
    raise ValueError(
        f"Unknown tier: {tier!r}. Valid tiers: {', '.join(sorted(VALID_TIERS))}"
    )
