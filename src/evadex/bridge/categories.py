...
_CATALOG_PREFIX_MAP: tuple[tuple[str, str], ...] = (
    ...
    ("mk_", "European IDs"),
    # Asia-Pacific
    ("au_", "Asia-Pacific IDs"),
    ("nz_", "Asia-Pacific IDs"),
    ("sg_", "Asia-Pacific IDs"),
    ("hk_", "Asia-Pacific IDs"),
    ("jp_", "Asia-Pacific IDs"),
    ("in_", "Asia-Pacific IDs"),
    ("kr_", "Asia-Pacific IDs"),
    ("cn_", "Asia-Pacific IDs"),
    ("tw_", "Asia-Pacific IDs"),
    ("th_", "Asia-Pacific IDs"),
    ("vn_", "Asia-Pacific IDs"),
    ("id_", "Asia-Pacific IDs"),
    ("ph_", "Asia-Pacific IDs"),
    ("my_", "Asia-Pacific IDs"),
    ("pk_", "Asia-Pacific IDs"),
    ("lk_", "Asia-Pacific IDs"),
    ("bd_", "Asia-Pacific IDs"),
    ("mo_", "Asia-Pacific IDs"),
    ("kh_", "Asia-Pacific IDs"),
    ("la_", "Asia-Pacific IDs"),
    ("mm_", "Asia-Pacific IDs"),
    ("mn_", "Asia-Pacific IDs"),
    ("np_", "Asia-Pacific IDs"),
    ("bt_", "Asia-Pacific IDs"),
    ("bn_", "Asia-Pacific IDs"),
    ("af_", "Asia-Pacific IDs"),
    ("fj_", "Asia-Pacific IDs"),
    ("pg_", "Asia-Pacific IDs"),
    ("ws_", "Asia-Pacific IDs"),
    ("to_", "Asia-Pacific IDs"),
    ("vu_", "Asia-Pacific IDs"),
    ("tv_", "Asia-Pacific IDs"),
    ("sb_", "Asia-Pacific IDs"),
    ("nr_", "Asia-Pacific IDs"),
    ("ki_", "Asia-Pacific IDs"),
    ("fm_", "Asia-Pacific IDs"),
    ("mh_", "Asia-Pacific IDs"),
    ("pw_", "Asia-Pacific IDs"),
    # Latin America
    ("br_", "Latin America IDs"),
    ("mx_", "Latin America IDs"),
    ("ar_", "Latin America IDs"),
    ("cl_", "Latin America IDs"),
    ("co_", "Latin America IDs"),
    ("pe_", "Latin America IDs"),
    ("uy_", "Latin America IDs"),
    ("ve_", "Latin America IDs"),
    ("bo_", "Latin America IDs"),
    ("py_", "Latin America IDs"),
    ("ec_", "Latin America IDs"),
    ("gy_", "Latin America IDs"),
    ("sr_", "Latin America IDs"),
    ("cr_", "Latin America IDs"),
    ("cu_", "Latin America IDs"),
    ("do_", "Latin America IDs"),
    ("ht_", "Latin America IDs"),
    ("jm_", "Latin America IDs"),
    ("bb_", "Latin America IDs"),
    ("bs_", "Latin America IDs"),
    ("bz_", "Latin America IDs"),
    ("gd_", "Latin America IDs"),
    ("kn_", "Latin America IDs"),
    ("lc_", "Latin America IDs"),
    ("vc_", "Latin America IDs"),
    ("tt_", "Latin America IDs"),
    ("ag_", "Latin America IDs"),
    ("dm_", "Latin America IDs"),
    # Middle East & Africa (longer prefixes first so uae_ beats ua_,
    # which lives under Europe).
    ("uae_", "Middle East & Africa IDs"),
    ("sa_", "Middle East & Africa IDs"),
    ("za_", "Middle East & Africa IDs"),
    ("il_", "Middle East & Africa IDs"),
    ("tr_", "Middle East & Africa IDs"),
    ("eg_", "Middle East & Africa IDs"),
    ("qa_", "Middle East & Africa IDs"),
    ("kw_", "Middle East & Africa IDs"),
    ("bh_", "Middle East & Africa IDs"),
    ("om_", "Middle East & Africa IDs"),
    ("ir_", "Middle East & Africa IDs"),
    ("iq_", "Middle East & Africa IDs"),
    ("jo_", "Middle East & Africa IDs"),
    ("lb_", "Middle East & Africa IDs"),
    ("sy_", "Middle East & Africa IDs"),
    ("ye_", "Middle East & Africa IDs"),
    ("ps_", "Middle East & Africa IDs"),
    ("ae_", "Middle East & Africa IDs"),
    # Africa — broader set
    ("ng_", "Middle East & Africa IDs"),
    ("ke_", "Middle East & Africa IDs"),
    ("ma_", "Middle East & Africa IDs"),
    ("dz_", "Middle East & Africa IDs"),
    ("tn_", "Middle East & Africa IDs"),
    ("et_", "Middle East & Africa IDs"),
    ("gh_", "Middle East & Africa IDs"),
    ("tz_", "Middle East & Africa IDs"),
    ("ug_", "Middle East & Africa IDs"),
    ("rw_", "Middle East & Africa IDs"),
    ("ao_", "Middle East & Africa IDs"),
    ("bj_", "Middle East & Africa IDs"),
    ("bw_", "Middle East & Africa IDs"),
    ("bf_", "Middle East & Africa IDs"),
    ("bi_", "Middle East & Africa IDs"),
    ("cm_", "Middle East & Africa IDs"),
    ("cv_", "Middle East & Africa IDs"),
    ("cf_", "Middle East & Africa IDs"),
    ("td_", "Middle East & Africa IDs"),
    ("km_", "Middle East & Africa IDs"),
    ("cd_", "Middle East & Africa IDs"),
    ("cg_", "Middle East & Africa IDs"),
    ("ci_", "Middle East & Africa IDs"),
    ("dj_", "Middle East & Africa IDs"),
    ("er_", "Middle East & Africa IDs"),
    ("ga_", "Middle East & Africa IDs"),
    ("gm_", "Middle East & Africa IDs"),
    ("gn_", "Middle East & Africa IDs"),
    ("gw_", "Middle East & Africa IDs"),
    ("gq_", "Middle East & Africa IDs"),
    ("sz_", "Middle East & Africa IDs"),
    ("ls_", "Middle East & Africa IDs"),
    ("lr_", "Middle East & Africa IDs"),
    ("ly_", "Middle East & Africa IDs"),
    ("mg_", "Middle East & Africa IDs"),
    ("mw_", "Middle East & Africa IDs"),
    ("ml_", "Middle East & Africa IDs"),
    ("mr_", "Middle East & Africa IDs"),
    ("mu_", "Middle East & Africa IDs"),
    ("mz_", "Middle East & Africa IDs"),
    ("na_", "Middle East & Africa IDs"),
    ("ne_", "Middle East & Africa IDs"),
    ("re_", "Middle East & Africa IDs"),
    ("sh_", "Middle East & Africa IDs"),
    ("sc_", "Middle East & Africa IDs"),
    ("sn_", "Middle East & Africa IDs"),
    ("sl_", "Middle East & Africa IDs"),
    ("so_", "Middle East & Africa IDs"),
    ("ss_", "Middle East & Africa IDs"),
    ("sd_", "Middle East & Africa IDs"),
    ("tg_", "Middle East & Africa IDs"),
    ("zm_", "Middle East & Africa IDs"),
    ("zw_", "Middle East & Africa IDs"),
    # Caucasus & Central Asia
    ("am_", "Asia-Pacific IDs"),
    ("az_", "Asia-Pacific IDs"),
    ("ge_", "Asia-Pacific IDs"),
    ("kz_", "Asia-Pacific IDs"),
    ("kg_", "Asia-Pacific IDs"),
    ("tj_", "Asia-Pacific IDs"),
    ("tm_", "Asia-Pacific IDs"),
    ("uz_", "Asia-Pacific IDs"),
...
def classify_category(value: str) -> str:
    ...
    for prefix, group in sorted(_CATALOG_PREFIX_MAP, key=lambda p: -len(p[0])):
        if value.startswith(prefix):
            ...
            if (
                "_health" in value
                or "_carecard" in value
                or "_ramq" in value
                or "medicare" in value
                or "_nhs" in value
                or "_npi" in value
                or "_mbi" in value
            ):
