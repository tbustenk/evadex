...
Current version: **3.27.0** (see `pyproject.toml`; CHANGELOG is the user-facing release notes). Test suite: **1080 unit + 300 integration = 1380** total; **all 1380 tests pass**. CI runs `tests/unit` on Python 3.11 and 3.13 plus a Docker image-build step (`.github/workflows/ci.yml`).
