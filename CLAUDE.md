...
Current version: **3.28.1** (see `pyproject.toml`; CHANGELOG is the user-facing release notes). Test suite: **1132 unit + 300 integration = 1432** total; **all 1432 tests pass**. CI runs `tests/unit` on Python 3.11 and 3.13 plus a Docker image-build step (`.github/workflows/ci.yml`).
